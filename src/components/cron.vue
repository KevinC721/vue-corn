...
export default {
  ...
  computed: {
    tableData () {
      return [{
        sVal: formatCorn(this.sVal),
        mVal: formatCorn(this.mVal),
        hVal: formatCorn(this.hVal),
        dVal: formatCorn(this.dVal),
        monthVal: formatCorn(this.monthVal),
        weekVal: formatCorn(this.weekVal),
        yearVal: formatCorn(this.yearVal)
      }]
    },
    value_ () {
